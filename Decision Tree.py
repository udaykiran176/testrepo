...
... disp = plot_confusion_matrix(dt, X_test, y_test, display_labels=iris.target_names, cmap=plt.cm.Blues, normalize=None)
...
print(f"Predicted class: {predicted_class} (Species: {predicted_species})")
